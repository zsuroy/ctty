...
func (m *helpModel) View() string {
	...
	leftColumn := lipgloss.JoinVertical(lipgloss.Left,
		...
		lipgloss.JoinHorizontal(lipgloss.Left,
			...
			m.styles.HelpText.Render("open serial device manager")),
		lipgloss.JoinHorizontal(lipgloss.Left,
	...
	rightColumn := lipgloss.JoinVertical(lipgloss.Left,
		...
		"",
		m.styles.FocusedLabel.Render("Serial (in serial view)"),
		"",
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("⏎  "),
			m.styles.HelpText.Render("connect to selected port")),
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("i  "),
			m.styles.HelpText.Render("show serial device info")),
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("e  "),
			m.styles.HelpText.Render("edit baud/parity/bits (in info view)")),
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("←/→ "),
			m.styles.HelpText.Render("cycle baud rate (or type directly)")),
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("a  "),
			m.styles.HelpText.Render("add serial device config")),
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("d  "),
			m.styles.HelpText.Render("delete saved serial device")),
		"",
		m.styles.FocusedLabel.Render("SFTP (in sftp view)"),
		"",
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("→  "),
			m.styles.HelpText.Render("open directory")),
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("←  "),
			m.styles.HelpText.Render("go to parent directory")),
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("⏎  "),
			m.styles.HelpText.Render("download file")),
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("u  "),
			m.styles.HelpText.Render("upload local file")),
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("d  "),
			m.styles.HelpText.Render("delete remote file")),
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("n  "),
			m.styles.HelpText.Render("create new directory")),
		lipgloss.JoinHorizontal(lipgloss.Left,
			m.styles.FocusedLabel.Render("r  "),
			m.styles.HelpText.Render("refresh current directory")),
		"",
